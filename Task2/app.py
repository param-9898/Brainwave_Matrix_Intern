...
class PasswordStrengthChecker:
    ...
    def assess_password_strength(self, password):
        ...
        length_valid = self.check_length(password)
        complexity_valid = self.check_complexity(password)
        uniqueness_valid = self.check_uniqueness(password)
        ...
        return {
            ...
            "complexityValid": complexity_valid,
            "uniquenessValid": uniqueness_valid
        }
